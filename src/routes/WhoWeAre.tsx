  ...
  return (
    <div>
      ...
      <Section title="Principles" subtitle="How we build and operate.">
        <ul className="grid gap-4 text-sm text-slate md:grid-cols-2">
          <li className="rounded-xl border border-mist p-5">Clarity over complexity.</li>
          <li className="rounded-xl border border-mist p-5">Traceability for every execution.</li>
          <li className="rounded-xl border border-mist p-5">Explainability for stakeholders.</li>
          <li className="rounded-xl border border-mist p-5">Operational outcomes that scale.</li>
        </ul>
      </Section>
    </div>
  );
